...
public class TestData extends BaseEntity{
	...
	@DatabaseField(columnName = "resultok", columnDefinition="bit(1)")
	private Boolean resultok;

	@DatabaseField(columnName = "check", columnDefinition="bit(1)")
	private Boolean check;

	@DatabaseField(columnName = "updated", columnDefinition="bit(1)")
