...
import com.xsx.ncd.ncd_manager.Activitys.Adapter.WifiListAdapter;
...
import com.xsx.ncd.ncd_manager.Activitys.Listeners.OnViewItemClickListener;
...
public class WifiSetActivity extends MyActivity {
    ...
    @BindView(R.id.wifi_switch_switch)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wifiListAdapter.setOnItemClickListener(new OnViewItemClickListener<MyWifiInfo>() {
            ...
            public void onItemClick(View view, int position, MyWifiInfo data) {
                ...
                {
                    comfirmDialog.showComfirmDialog(getFragmentManager(), comfirmDialogTag, getResources().getString(R.string.dialog_title_info_text),
